...
//        Тип снаряда
    ...
    [Header("Название башни")]
    public string NameTower;

    [Header("Урон")]
    public List<float> Damage;

    [Header("Радиус поражения башни")]
    public List<float> AffectedArea;

    [Header("Скорость стрельбы раз/сек")]
    public List<float> FireSpeed;

    [Header("Цена Покупки/Обновления")] 
