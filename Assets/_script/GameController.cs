...
namespace BSU
{
    public class GameController: MonoBehaviour
    {
        ...
        private Pool EnemyType1;
        private Pool EnemyType2;
        ...
        private void Awake()
        {
            ...
            EnemyType1 = new Pool(GameController.Instance.Enemies[0],new GameObject("For Type1").transform, SpawnAgent.position,10);
            EnemyType2 = new Pool(GameController.Instance.Enemies[1],new GameObject("For Type2").transform, SpawnAgent.position,10);
